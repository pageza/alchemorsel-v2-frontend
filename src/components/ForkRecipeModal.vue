<template>
  <v-dialog v-model="show" max-width="500px">
    <v-card>
      <v-card-title class="text-h5 font-weight-bold"> Fork Recipe </v-card-title>

      <v-card-text>
        <p class="text-body-1 mb-4">
          Tell us what you'd like to change about this recipe and we'll create a customized version
          for you!
        </p>
        ...
        <v-alert v-if="isSubmitting" type="info" variant="tonal" class="mt-4">
